	...
	for ls in matrix:
		...
		for num in ls:
			if num==0:
				...
				templist1.append(colored("BYU!", "blue"))
				templist2.append(colored("BYU!", "blue"))
			elif num==4:
				templist1.append(colored("UTAH", "red"))
				templist2.append(colored("UTAH", "red"))
			elif num==53:
